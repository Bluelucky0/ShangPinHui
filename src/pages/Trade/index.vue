  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="addressCheck(address, userAddress)">
...
import { reqSubmitOrder } from "@/api/service/trade";
export default {
  name: "Trade",
  data() {
    return {
  ...
  computed: {
    ...mapState({
      ...
      orderInfo: (state) => state.trade.tradeInfo,
    }),
    userDefaultAddress() {
  ...
  methods: {
    addressCheck(address, userAddress) {
